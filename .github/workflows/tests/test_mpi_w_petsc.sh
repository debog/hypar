...
export MPI_EXEC="mpirun --oversubscribe"
...
hypar_benchmarks_repo="https://github.com/debog/hypar_benchmarks_mpi_w_petsc.git"
...
HYPAR_DIFF_CMD="$root_dir/$HYPAR_DIFF -r 1.0e-10 "
