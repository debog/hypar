/*! @file Interp1PrimFourthOrderCentral.c
    @author Debojyoti Ghosh
    @brief 4th order central scheme (component-wise application to vectors)
*/
...
/*! @brief 4th order central reconstruction (component-wise) on a uniform grid
    ...
    \f}
    where \f$x\f$ is the spatial coordinate along the dimension of the interpolation. This function computes the 4th order central numerical approximation
    \f$\hat{\bf f}_{j+1/2} \approx {\bf h}_{j+1/2}\f$ as:
    \f{equation}{
      \hat{\bf f}_{j+1/2} = -\frac{1}{12} {\bf f}_{j-1} + \frac{7}{12} {\bf f}_{j} + \frac{7}{12} {\bf f}_{j+1} - \frac{1}{12} {\bf f}_{j+2}.
    \f}
