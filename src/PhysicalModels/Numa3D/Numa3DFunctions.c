...
int Numa3DCalculateStandardAtmosphere_1(void *a_p,double a_z,double *a_ExnerP,double *a_P,double *a_rho,double *a_T)
{
  Numa3D *physics = (Numa3D*) a_p;
...
int Numa3DCalculateStandardAtmosphere_2(void *a_p,double a_z,double *a_ExnerP,double *a_P,double *a_rho,double *a_T)
{
  Numa3D *physics = (Numa3D*) a_p;
